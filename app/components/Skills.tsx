...
const SkillItem = ({title,icon,description} : SkillItem) =>{
  return (
    <li className='relative flex w-full flex-1 flex-col items-center text-center shadow-[0_35px_40px_-15px_rgba(0,0,0,0.2)] rounded-2xl p-10 hover:bg-blue-500 group duration-[1200ms] transition'>
